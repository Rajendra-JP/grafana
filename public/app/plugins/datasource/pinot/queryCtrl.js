...
function (angular, _, PinotQueryBuilder) {
  'use strict';

  var module = angular.module('grafana.controllers');

  module.controller('PinotQueryCtrl', function($scope, $timeout, $sce, templateSrv, $q, uiSegmentSrv) {
    ...
    $scope.init = function() {
      ...
      target.fields = target.fields || [{
        name: 'value',
        func: target.function || 'avg'
      }];

      $scope.queryBuilder = new PinotQueryBuilder(target);
