  ...
  module.factory('DruidDatasource', function($q, $http, templateSrv, $timeout, $log) {
    ...
    */
    ...
    DruidDatasource.prototype.query = function(options) {
      console.log("Druid query options: ");
      console.log(options);
      ...
      var promises = options.targets.map(function (target) {
        console.log("Druid query target: ");
        console.log(target);
    ...
    DruidDatasource.prototype._topNQuery = function(
        datasource,
        intervals,
        granularity,
        filters,
    ...
    DruidDatasource.prototype._groupByQuery = function(
        datasource,
        intervals,
        granularity,
        filters,
    ...
    function computeGranularity(from, to, maxDataPoints) {
      ...
      */
      ...
      $log.debug(
        "Calculated \"" + granularityEntry[0]  +
        "\" granularity [" + Math.ceil(intervalSecs/granularityEntry[1].asSeconds()) +
        " pts]" + " for " + (intervalSecs/60).toFixed(0) + " minutes and max of " + maxDataPoints +
        " data points");
